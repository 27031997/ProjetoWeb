...
public class WebConfig implements WebMvcConfigurer {
	...
	@Bean
	public List<Login> arrayLogin() { 
		System.out.println("### Lista de alunos está sendo criada e logada ###");
		return new ArrayList<Login>();
	}
	@Bean
	public List<Cadastro> arrayCadastro() { 
		System.out.println("### Lista de alunos está sendo criada e cadastrada ###");
